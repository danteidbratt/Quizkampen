...
public class Window extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == welcomeScreen.okButton || e.getSource() == welcomeScreen.userNameInput) {
            ...
            gameScreen.answer1Button.setText(session.getCurrentQuestions().get(0).getAnswerAlternative(0).getAnswer());
            gameScreen.answer2Button.setText(session.getCurrentQuestions().get(0).getAnswerAlternative(1).getAnswer());
            gameScreen.answer3Button.setText(session.getCurrentQuestions().get(0).getAnswerAlternative(2).getAnswer());
            gameScreen.answer4Button.setText(session.getCurrentQuestions().get(0).getAnswerAlternative(3).getAnswer());
            add(gameScreen);
